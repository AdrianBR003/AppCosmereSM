...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isLoginSkipped) {
            // Si se ha omitido el inicio de sesión, redirigir directamente
            ...
            override fun onGlobalLayout() {
                ...
                if (containerHeight > 0 && containerWidth > 0) {
                    for ((index, libro) in libros.withIndex()) {
                        ...
                        val drawableId = obtenerDrawablePorNombre(libro.nombrePortada)
    ...
    private fun animateBookCover(
        ...
        val valorA = (Random().nextFloat() * 0.5f) + 0.4f
        ...
        animatorSet.startDelay = (Random().nextInt(3000) + 2000).toLong() // Inicio de las animaciones - Retraso aleatorio entre 1 y 3 segundos
